...
@Component({
  selector: 'app-nationaliter',
  templateUrl: './nationaliter.component.html',
  styleUrls: ['./nationaliter.component.css','.../../../src/assets/css/newStyle.css'
    , '.../../../src/assets/css/StyleApplication.css'], providers: [ConfirmationService, MessageService]
})
export class NationaliterComponent  implements OnInit {
 @ViewChild('codeError') codeErrorElement!: ElementRef; 
    ...
    @Output() closed: EventEmitter<string> = new EventEmitter();
     ...
     DeleteNationalite(code: any) {
       this.param_service.DeleteNationalite(code).subscribe(
         (res: any) => {
     ...
     public onOpenModal(mode: string) {
       ...
       if (mode === 'Print') {
         if (this.code == undefined) {
           ...
           this.formHeader = "Imprimer Liste Nationalite"
     ...
     PostNationalite() {
       ...
       if (isValid) {
         ...
         if (this.code != null) {
           ...
           this.param_service.UpdateNationalite(body).subscribe(
           ...
           this.param_service.PostNationalite(body).subscribe(
             (res: any) => {
               this.CtrlAlertify.PostionLabelNotification();
               this.CtrlAlertify.ShowSavedOK();
               this.visibleModal = false;
     ...
     GetAllNationalite() {
       this.param_service.GetNationalite().subscribe((data: any) => {
