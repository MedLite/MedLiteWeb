...
@Component({
  selector: 'app-responsable-remise',
  templateUrl: './responsable-remise.component.html',
  styleUrls: ['./responsable-remise.component.css','.../../../src/assets/css/newStyle.css'
  , '.../../../src/assets/css/StyleApplication.css'], providers: [ConfirmationService, MessageService]
})
export class ResponsableRemiseComponent {
